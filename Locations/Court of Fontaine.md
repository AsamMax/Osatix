...
![[Pasted image 20260506145601.png]]
## Key Details

- **Waterway central station**
	- Central tower where the elevated [[Aquabus]] converge and the main entry and exit to the city. Heavily secured and surveyed.
- **Palais Mermonia**
	- Bureaucratic center of the government. Place to submit applications for all kinds of licences
- **The Steambird**
